...
# I left in all the default documentation so it is easier to understand for
# new commers. Double indented lines are my additions or changes.
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # the file ubuntu_13-10.pp in the manifests_path directory.
  #
